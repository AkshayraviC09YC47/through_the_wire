...
def do_banner():
    print(r"")
    print(r"   _____ _                           _     ")
    print(r"  /__   \ |__  _ __ ___  _   _  __ _| |__  ") 
    print(r"    / /\/ '_ \| '__/ _ \| | | |/ _` | '_ \ ") 
    print(r"   / /  | | | | | | (_) | |_| | (_| | | | |")
    print(r"   \/   |_| |_|_|  \___/ \__,_|\__, |_| |_|")
    print(r"                               |___/       ")
    print(r"   _____ _            __    __ _           ")
    print(r"  /__   \ |__   ___  / / /\ \ (_)_ __ ___  ")
    print(r"    / /\/ '_ \ / _ \ \ \/  \/ / | '__/ _ \ ")
    print(r"   / /  | | | |  __/  \  /\  /| | | |  __/ ")
    print(r"   \/   |_| |_|\___|   \/  \/ |_|_|  \___| ")
    print(r"")
    print(r"                 jbaines-r7                ")
    print(r"               CVE-2022-26134              ")
    print(r"      \"Spit my soul through the wire\"    ")
    print(r"                     🦞                   ")
    print(r"") 
